package com.example.mvpexample.common;
...
public class OkHttpUtils {
    ...
    private void postRequest(String url, final ResultCallback callback, String params) {
     ...
     * @param params    请求参数
     */
    public static void post(String url, final ResultCallback callback, String params) {
        getmInstance().postRequest(url, callback, params);
    }
